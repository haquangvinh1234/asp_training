<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bai4.aspx.cs" Inherits="Lap1.bai4" %>
    ...
    <form id="form1" runat="server">
        <div>
            <div class="menu"> 
              ...
              <asp:Label ID="lbl1" runat="server" Text="Giải PT bậc nhất ax + b = 0"></asp:Label>
        ...
        <div>
            ...
            <asp:Button ID="Tinh" runat="server" Text="Tính" OnClick="Tim_Click" />
